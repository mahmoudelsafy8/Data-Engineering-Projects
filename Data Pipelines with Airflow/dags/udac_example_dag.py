...
"""
In This Airflow Pipeline DAG will do following below:
- Insert fact & dimension tables from S3 bucket.
- Load the database to Amazon Redshift.
- Run quality check to verify the data.
- End the operator.
